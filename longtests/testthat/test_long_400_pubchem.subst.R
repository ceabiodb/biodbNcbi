# Set test context
biodb::testContext("Pubchem Subst long tests")
...
# Create connector
conn <- biodb$getFactory()$createConn('ncbi.pubchem.subst')
...
biodb::runGenericTests(conn, pkgName="biodbNcbi", short=FALSE, long=TRUE,
